...
//        private readonly TicketFactory _ticketFactory;
        ...
        private const string WrongTypeMessage = "Not a Task. Check type before calling method.";
...
//                        tickets.Add(StringToTicket(line));
        ...
        /// <summary>
        /// Parses a formatted <c>string</c> into a <c>Task</c> object.
        /// </summary>
        /// <param name="ticketString">The formatted <c>string</c> to be parsed.</param>
        /// <returns>A <c>Task</c> object, parsed from a formatted <c>string</c>.</returns>
//        private Task StringToTicket(string ticketString)
//        {
...
//            }
//
//            var ticket = new Task(subs[0].ToInt(), subs[1], subs[2].ToStatus(), subs[3].ToPriority(), subs[4], subs[5], watching, subs[7], subs[8].ToDateTime(), ref _display);
//
//            return ticket;
//        }
